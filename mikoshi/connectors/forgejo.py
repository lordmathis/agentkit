...
class ForgejoClient(ConnectorClient):
    """Client for interacting with Gitea/Forgejo REST API"""
    ...
    def __init__(self, token: str, base_url: str):
        """Initialize Forgejo client with authentication token

        Args:
            token: Forgejo/Gitea personal access token
            base_url: Base URL for the Forgejo/Gitea instance
        """
        self.token = token
